...
public class HeadlessSimple {
    ...
    public void script() {
        ...
        Container container;
        try {
        	String filePath = new File(HeadlessSimple.class.getResource("/").toURI()).getAbsolutePath();
        	System.out.println(filePath+"/polblogs.gml");
        	//这个文件在哪里 哪个？
        ...
        try {
            ...
            ec.exportFile(new File("headless_simple2.pdf"));
